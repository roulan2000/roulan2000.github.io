...
![img](https://raw.githubusercontent.com/roulan2000/roulan2000.github.io/main/images/jekyllbugs1.png)

### 借助bundle debug

为了debug，我cd到合适的位置，命令行输入`jekyll new testblog`，创建一个新的文件夹，然后cd进去，再次输入`jekyll server`

![img](https://raw.githubusercontent.com/roulan2000/roulan2000.github.io/main/images/jekyllbugs2.png)
